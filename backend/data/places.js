// University of Limpopo Campus places (approximate coordinates for demo map)
// Center roughly around -23.886, 29.738 (Turfloop campus area)
...
const categories = [
  ...
  { id: "parking", name: "Transport & Parking", icon: "parking", color: "#3B82F6" }
];

// Simple graph for routing (connected places with approximate distances in meters)
const connections = [
...
module.exports = { places, categories, connections };
